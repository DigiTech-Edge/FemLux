        ...
        <div className="space-y-8">
          <section className="animate-in slide-in-from-bottom duration-700 delay-150">
            ...
            <p className="text-gray-600">
              By accessing and using FemLux&apos;s website and services, you
              ...
              through our website or from FemLux.
            </p>
          </section>
          ...
          <section className="animate-in slide-in-from-bottom duration-700 delay-600">
            ...
            <p className="text-gray-600">
              When you use our website or send emails to us, you are
              ...
              you by email or by posting notices on this site.
            </p>
          </section>
          ...
          <section className="animate-in slide-in-from-bottom duration-700 delay-900">
            ...
            <p className="text-gray-600">
              Please review our Shipping Policy and Return Policy for
              information on how we ship items and handle returns. By making a
