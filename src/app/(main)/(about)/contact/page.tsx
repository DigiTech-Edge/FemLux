      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div className="animate-in slide-in-from-left duration-700">
          ...
          <p className="text-gray-600 mb-8">
            ...
            our products, need assistance with an order, or want to provide
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 text-gray-600">
              ...
              <span>Femlux563@gmail.com</span>
            </div>
            <div className="flex items-center space-x-4 text-gray-600">
              <Phone className="w-5 h-5 text-pink-500" />
              <span>0530555785 / 0554329248</span>
            </div>
            <div className="flex items-center space-x-4 text-gray-600">
        ...
        <div className="animate-in slide-in-from-right duration-700">
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600">
              Our dedicated customer support team typically responds within 24
              hours during business hours. For urgent matters, please contact us
              by phone.
            </p>
          </div>
        </div>
